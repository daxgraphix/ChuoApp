...
<html>
	...
	<head>
		<title>Welcome  To ChuoApp- Sign up, Log in, Chat </title>
...
<body>
	...
	<div id="container">
		...
		<!--<legend>Profile information</legend>-->
			<table cellpadding="5" cellspacing="5">
				...
				<tr>
					...
					<td><input type="text" name="number" placeholder="+255...." maxlength="13" class="form-1" title="Enter your mobile number" required /></td>
				</tr>
			</table>
		</fieldset>
		...
		<br />
			...
			<strong>Yes, I have read and I accept the <a href="#">daxsocial Terms of Use</a> and the <a href="#">daxsocial Privacy Statement</a></strong>
